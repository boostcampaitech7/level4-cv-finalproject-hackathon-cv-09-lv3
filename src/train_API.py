...
def create_tuning():
    ...
    request_data = {'name': 'kimi_dataset_v3',
                    'model': 'HCX-003',
                    'tuningType': 'PEFT',
                    'taskType': 'GENERATION',
                    'trainEpochs': '2',
                    ...
                    'trainingDatasetFilePath': 'finetune_dataset_v3.csv',
...
def get_tuning():
    ...
    taskId = '4cecebci'#'1gpv430k' #'fv49hciz' #'efa0ojx3' #'2wk3jmlb' #'2wk3hqg0'
...
class GetDemoExecutor:
    ...
    def execute(self, completion_request):
        ...
        with requests.post(self._host + '/testapp/v2/tasks/fv49hciz/chat-completions',
